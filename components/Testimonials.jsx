  ...
  return (
    <div className="flex flex-col mx-auto px-5">
      ...
      <div className="flex flex-row justify-center pb-10">
        ...
        <div className="flex flex-col relative h-40 md:h-96 w-96 overflow-x-auto justify-center ">
          <p className="whitespace-pre-wrap overflow-y-auto  text-center justify-center align-middle bg-[#ac1010] bg-opacity-80 font-bold shadow-xl rounded-xl p-5 text-[#e3cba3] md:flex-col md:justify-center">
